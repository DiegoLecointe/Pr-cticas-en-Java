...
public class Principal extends JFrame implements ActionListener {
    ...
    private JLabel labelLogo, labelBienvenido, labelTitle, labelNombre, labelAParerno, labelAMaterno,
    ...
    public Principal() {
        ...
        mb = new JMenuBar();
        mb.setBackground(new Color(238, 0, 42));
        setJMenuBar(mb);
        ...
        labelLogo.setBounds(5, 5, 240, 100);
        add(labelLogo);
        ...
        labelAParerno = new JLabel("Apellido Paterno");
        labelAParerno.setBounds(25, 248, 180, 25);
        labelAParerno.setFont(new Font("Andale Mono", 1, 12));
        labelAParerno.setForeground(new Color(255, 255, 255));
        add(labelAParerno);
        ...
        labelDepartamento.setBounds(220, 180, 180, 25);
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == miCalculo) {
            ...
            if (nombreTrabajador.equals("") || AP.equals("") || AM.equals("") || Departamento.equals("") || Antiguedad.equals("")) {
                ...
                // Inicio if (Departamento.equals("Atención al Cliente")) 
                if (Departamento.equals("Atención al Cliente")) {
                    ...
                    // Fin if (Departamento.equals("Atención al Cliente")) 

                    // Inicio if (Departamento.equals("Departamento de Logística")) 
                }
                if (Departamento.equals("Departamento de Logística")) {
                    ...
                    // Fin if (Departamento.equals("Departamento de Logística"))

                    // Inicio if (Departamento.equals("Departamento de Gerencia"))
                }
                ...
                // Fin if (Departamento.equals("Departamento de Gerencia"))
            } //fin else
        ...
        if (e.getSource() == miElCreador) {
            JOptionPane.showInternalMessageDialog(null, "Desarrollado por Diego Alejandro Hernández Lecointe");
        }
    }
