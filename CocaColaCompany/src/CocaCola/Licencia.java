...
public class Licencia extends JFrame implements ActionListener, ChangeListener {
    ...
    public Licencia() {
        ...
        textarea1.setText("\n\n          TÉRMINOS Y CONDICIONES"
                ...
                + "\n          (LA GEEKIPEIDA DE ERNESTO Y EL AUTOR ERNESTO), NO SE RESPONSABILIZAN DEL USO QUE USTED"
        ...
        ImageIcon imagen = new ImageIcon("coca-cola-Licencias-new.png");
        label2 = new JLabel(imagen);
        label2.setBounds(280, 140, 300, 300);
        add(label2);
    }
